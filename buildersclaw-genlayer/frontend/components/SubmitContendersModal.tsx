...
const SAMPLE_CONTENDERS: Contender[] = [
  {
    ...
    repo_summary: "Next.js app with real-time crypto price feed, live sorting, and portfolio tracker.",
    gemini_score: 82,
  ...
  },
  {
    ...
    repo_summary: "React + TailwindCSS dashboard showing top 10 tokens with 7-day chart history.",
    gemini_score: 78,
  ...
  },
  {
    ...
    repo_summary: "Vue.js single-page app with WebSocket price updates and responsive UI.",
    gemini_score: 75,
